...
class Speedometer():
    def changerange(self,Range=(-10,190),rfont=("Verdana",12)):
        for i in range(-10,195,10):
            self.canvas.itemconfig(self.range_marks[int((i+10)/10)],text=str((i+10)),font=rfont)                        
    def moveto(self,value,tag):
        #tet = self.canvas.create_text()
        ...
        #tet = self.canvas.create_text(300,300,text=str(value),font=("Courier",20))
        
           
    def __init__(self,canvas,tag,bg="#ffffff",needlecolor="#0d47a1",markscolor="#000000",Range=(0,200),digitscolor="#e80e20"):
        self.range=Range
        ...
        canvas.create_oval(self.radius-30,self.radius-30,self.radius+30,self.radius+30,fill="#0e19e8")
